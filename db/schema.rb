...
ActiveRecord::Schema.define(version: 20150624072419) do
  ...
  add_index "attendances", ["user_id", "work_date"], name: "index_attendances_on_user_id_and_work_date", unique: true, using: :btree
